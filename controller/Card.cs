...
public class Card : ICard
{
	...
	public static Card Spade4 = new Card(CardType.Spade, 4, CardAbility.Unknown, 3);
	public static Card Spade5 = new Card(CardType.Spade, 5, CardAbility.Unknown, 4);
	...
	public static Card Spade10 = new Card(CardType.Spade, 10, CardAbility.Unknown, 9);
	public static Card SpadeJ = new Card(CardType.Spade, 11, CardAbility.Unknown, 10);
	public static Card SpadeQ = new Card(CardType.Spade, 12, CardAbility.Unknown, 11);
	public static Card SpadeK = new Card(CardType.Spade, 13, CardAbility.Unknown, 12);
	...
	public static Card Heart4 = new Card(CardType.Heart, 4, CardAbility.Unknown, 16);
	public static Card Heart5 = new Card(CardType.Heart, 5, CardAbility.Unknown, 17);
	...
	public static Card Heart10 = new  Card(CardType.Heart, 10, CardAbility.Unknown, 22);
	public static Card HeartJ = new Card(CardType.Heart, 11, CardAbility.Unknown, 23);
	public static Card HeartQ = new Card(CardType.Heart, 12, CardAbility.Unknown, 24);
	public static Card HeartK = new Card(CardType.Heart, 13, CardAbility.Unknown, 25);
	...
	public static Card Diamond4 = new Card(CardType.Diamond, 4, CardAbility.Unknown, 29);
	public static Card Diamond5 = new Card(CardType.Diamond, 5, CardAbility.Unknown, 30);
	...
	public static Card Diamond10 = new Card(CardType.Diamond, 10, CardAbility.Unknown,35);
	public static Card DiamondJ = new Card(CardType.Diamond, 11, CardAbility.Unknown, 36);
	public static Card DiamondQ = new Card(CardType.Diamond, 12, CardAbility.Unknown, 37);
	public static Card DiamondK = new Card(CardType.Diamond, 13, CardAbility.Unknown, 38);
	...
	public static Card Club4 = new Card(CardType.Club, 4, CardAbility.Unknown, 42);
	public static Card Club5 = new Card(CardType.Club, 5, CardAbility.Unknown, 43);
	...
	public static Card Club10 = new Card(CardType.Club, 10, CardAbility.Unknown, 48);
	public static Card ClubJ = new Card(CardType.Club, 11, CardAbility.AddNumber10, 49);
